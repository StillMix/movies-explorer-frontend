   ...
   <> 
    <div className="portfolio">
           ...
           <div className="portfolio__container">
              {
                  linkCard.map((i) => {
                      return <a key={i.id} href={i.link} target="_blank" rel="noreferrer" className="portfolio__link" >{i.name}<span><img className="portfolio__img" src={i.img} alt="Ссылки"></img></span></a>
                  })
              }
